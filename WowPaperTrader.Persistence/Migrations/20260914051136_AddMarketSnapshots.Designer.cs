...
namespace WowPaperTrader.Persistence.Migrations
{
    ...
    [Migration("20260914051136_AddMarketSnapshots")]
            ...
            modelBuilder.Entity("WowPaperTrader.Application.Features.Write.AuctionHouseSnapshot.MarketAggregates.CurrentPriceLevel", b =>
                {
                    ...
                    b.Property<long>("AuctionMarketSnapshotAuctionMarketId")
                        .HasColumnType("bigint");

                    b.Property<long>("AuctionMarketSnapshotId")
                        .HasColumnType("bigint");

                    b.Property<DateTime>("AuctionMarketSnapshotObservedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("AuctionMarketSnapshotAuctionMarketId", "AuctionMarketSnapshotObservedAtUtc");

                    b.ToTable("CurrentPriceLevel");
                });
            ...
            modelBuilder.Entity("WowPaperTrader.Application.Features.Write.AuctionHouseSnapshot.MarketAggregates.CurrentPriceLevel", b =>
                {
                    b.HasOne("WowPaperTrader.Application.Features.Write.AuctionHouseSnapshot.MarketAggregates.AuctionMarketSnapshot", "AuctionMarketSnapshot")
                        ...
                        .HasForeignKey("AuctionMarketSnapshotAuctionMarketId", "AuctionMarketSnapshotObservedAtUtc")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
